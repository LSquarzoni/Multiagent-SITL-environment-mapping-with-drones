...
if __name__ == "__main__":
    ...
    parser.add_argument('--base_link_name', default="base_link_AAA")
    parser.add_argument('--camera_plugin_name', default="camera_controller_AAA")
    parser.add_argument('--camera_name', default="camera_AAA")
    parser.add_argument('--camera_link_name', default="camera_link_AAA")
